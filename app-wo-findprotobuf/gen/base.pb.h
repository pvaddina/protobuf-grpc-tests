...
class BaseMsg PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Base.BaseMsg) */ {
 public:
...
inline const std::string& BaseMsg::_internal_name() const {
  return name_.Get();
}
inline void BaseMsg::_internal_set_name(const std::string& value) {
...
inline std::string* BaseMsg::_internal_mutable_name() {
...
inline std::string* BaseMsg::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Base.BaseMsg.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void BaseMsg::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Base.BaseMsg.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 BaseMsg::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 BaseMsg::id() const {
  // @@protoc_insertion_point(field_get:Base.BaseMsg.id)
  return _internal_id();
}
inline void BaseMsg::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  id_ = value;
}
inline void BaseMsg::set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
